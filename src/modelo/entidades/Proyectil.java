...
public abstract class Proyectil extends GameObject implements Movible {
    ...
    public Proyectil(float posicionX, float posicionY, float posicionZ, int ancho, int alto, boolean existe,
            BufferedImage spriteActual, double velocidadProyectil, Integer danoProyectil, Direccion direccion,
            Personaje dueno) {
