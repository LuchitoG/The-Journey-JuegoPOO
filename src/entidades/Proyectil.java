...
public Proyectil(float posicionX, float posicionY, double velocidadProyectil, 
    ...
    if(velocidadProyectil <= 0.0) throw new IllegalArgumentException("Velocidad de proyectil invalida");
    if(danoProyectil == null || danoProyectil <= 0) throw new IllegalArgumentException("Daño de proyectil invalido");
    if (tamanoHeight == null || tamanoHeight <= 0) throw new IllegalArgumentException("valor de altura del proyectil invalido");
    if (tamanoWidth == null || tamanoWidth <= 0) throw new IllegalArgumentException("valor de ancho del proyectil invalido");
...
public double getVelocidadProyectil(){return velocidadProyectil; }
public Integer getDanoProyectil(){return danoProyectil; }

public Integer getTamanoWidth(){return tamanoWidth; }
public Integer getTamanoHeight(){return tamanoHeight; }

//Setters no van, tengo entendido que bugean las "fisicas" de la bala, despues preguntar bien a los profes
...
// No es complejo de pensar, pero tuve que usar IA pq no supe como implementarlo (era una re pavada)
...
el mismo tiene 4 premisas, aca las implemento, un saludo al indio alibaba ingeniero de chutub*/
